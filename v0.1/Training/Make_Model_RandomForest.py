...
# RandomFoerst를 생성. 주어진 데이터를 두 개의 클래스로 분류함
clf = RandomForestClassifier(max_depth=100 ,n_estimators=5, random_state=0)
...
print(f"예측치 정확도: {metrics.accuracy_score(y_test, predictionY)}")
